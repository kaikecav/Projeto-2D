...
public class CamaI : MonoBehaviour
{
    [Header("Informações do puzile")]
    [SerializeField] private UnityEvent _evento;

    [Header("Objetos do puzile")]
    [SerializeField] private GameObject _camaInterativo;
    [SerializeField] private GameObject _cama;
    ...
    public void EndPuzzle()
    {
        ...
        _camaInterativo.SetActive(true);
    ...
    IEnumerator PuzzleStart()
    {
        ...
        _camaInterativo.SetActive(false);
